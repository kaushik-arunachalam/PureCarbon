...
/* package kaushik-0.1.0.0 */
#ifndef VERSION_kaushik
#define VERSION_kaushik "0.1.0.0"
#endif /* VERSION_kaushik */
#ifndef MIN_VERSION_kaushik
#define MIN_VERSION_kaushik(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_kaushik */
...
#define CURRENT_COMPONENT_ID "kaushik-0.1.0.0-inplace-kaushik"
